...
description: "Every organization in Pluvo has one **Base Scenario**—your financial source of truth. Other scenarios are branches created from the base that inherit"
---
