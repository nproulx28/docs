...
**Direct Connectors.** Connect straight to an app's own API for a native link: Xero, QuickBooks, Stripe, Salesforce, Acumatica, Ramp, Measure, and Float.
...
**File Upload.** Upload your own spreadsheets and CSVs, or add a **Freeform Text** source when the context you want to share is written rather than tabular.
