...
Commenting lets you and your team talk about the work right where it lives, so feedback stays attached to the exact thing it refers to instead of getting lost in email. Notifications then make sure the people involved know when something needs them, whether that is a mention, a reply, or something being shared with them.

## Commenting

You can add comments on **dashboards**, anchored to the chart you are discussing. Comments appear in a panel alongside the content, and each comment can hold a full back-and-forth thread.

### Add and manage comments

<Steps>
  <Step title="Open the comments panel">
    On a dashboard, open the comments panel to see the discussion for that item.
  </Step>
...
The comments panel lets you switch between **All**, **Open**, and **Resolved**, so you can focus on what still needs attention or look back at what has already been closed out. Unread comments are flagged so you can spot new activity quickly, and each comment shows where it is anchored so you know which part of the dashboard it refers to.
...
- someone **replies** to a comment thread you are part of
- someone **shares** something with you, such as an artifact
